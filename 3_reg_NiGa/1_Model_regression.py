...
num_features = data_graph[0].num_features
batch_size_tem = [32]
hidden_dim = [256]      ### Number of units in hidden layer 1
dropout = [0.1]
...
## NiGa
# Metrics train: mae 0.02036 mse 0.00091 R2 0.99930
# Metrics validation: mae 0.02351 mse 0.00148 R2 0.99890
# Metrics test: mae 0.02377 mse 0.00180 R2 0.99849


##Alloys
# Metrics train: mae 0.18290 mse 0.07270 R2 0.98156
# Metrics validation: mae 0.28598 mse 0.21498 R2 0.94461
# Metrics test: mae 0.27220 mse 0.18121 R2 0.95353

##CatBoost
# Metrics train: mae 0.12831 mse 0.06682 R2 0.98321
# Metrics validation: mae 0.33216 mse 0.37238 R2 0.90439
# Metrics test: mae 0.33613 mse 0.41491 R2 0.89355

lin_teo = np.arange(-1.7, 6.5, 0.1)
...
plt.axis('square')
plt.legend()
plt.title(label='ML vs DFT reaction energy\nfor the GNN model', fontsize=13)
plt.tight_layout()
plt.savefig('Predict_vs_Real_NiGa.png', dpi=dpi_qua)
...
save_pickle("train_nodes_mask_NiGa.pkl", list_node_mask)
save_pickle("train_edge_mask_NiGa.pkl", list_edge_mask)
save_pickle("train_node_import_NiGa.pkl", node_import)
...
save_pickle("Input_linear_GNN_NiGa.pkl", handles)

sorted_df = data_pd.iloc[index_sort].reset_index(drop=True)

sorted_df.to_pickle("sorted_data_clustering_NiGa.pkl")
